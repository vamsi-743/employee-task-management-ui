...
import { createDesignation, emsCreateDesignation } from '@/http/api'
import { useMutation, useQueryClient } from '@tanstack/react-query'


import { useToast } from '@/components/ui/use-toast'
import DesignationEditBtn from './designation-edit-btn'
...
export default function DesignationTable({
  ...
  const mutation = useMutation({
    mutationFn: emsCreateDesignation,
    onSuccess: () => {
      toast({
      ...
      queryClient.invalidateQueries({ queryKey: ['ems_designations'] })
    },
    onError: (error) => {
      toast({
